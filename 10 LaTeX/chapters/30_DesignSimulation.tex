...
The rest of this chapter shows the design and development of the OCT imaging path for the multimodal probe. However, in order to independently test the behavior of the OCT scanner and optics, a single modality probe was fabricated as a demonstrator. Therefore, for completeness, both multi-mode and single-mode optical systems are described.
